...
/**
 * Abstract movie view holder base for [ComingSoonAdapter].
 */
abstract class MovieBaseHolder(
  itemView: View, protected val baseUrl: String,
  protected val sizes: List<String>
  ...
  /**
   * Provides the movie cover imageview size for specific [MovieBaseHolder]
   * subclass.
   */
